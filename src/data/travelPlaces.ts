...
export const mockTravelPlaces: TravelPlace[] = [
  ...
  },
 {
  ...
  },
  {
    ...
    description: 'Suki Chang Phueak at the night market is a famous street food stall that has been a favorite among locals for a long time. The specialty here is the dry suki with its signature wok aroma, served with generous portions at an affordable price. A must-try delicacy in Chiang Mai.',
    country: 'Thailand',
    rating: 4.5,
    distance: "~2.2km",
    tags: ["Street", "Culture"]
  },
  {
    ...
    description: 'Khao-Sō-i is a relatively new establishment but stands out with its chewy fresh Khao Soi noodles made right before your eyes. The rich, authentic broth and Japanese-style decor offer a unique twist on the traditional Khao Soi experience.',
    country: 'Thailand',
    rating: 4.8,
    distance: "~6.8km",
    tags: ["Street", "Culture"]
