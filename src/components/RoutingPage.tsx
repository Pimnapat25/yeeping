...
const RoutingPage: React.FC = () => {
  ...
  const optimizeRoute = React.useCallback((places: TravelPlace[], personality?: string, duration?: string): TravelPlace[] => {
    ...
    if (duration === '1 day trip') {
      maxPlaces = 3;
    } else if (duration === '2 days 1 night') {
      maxPlaces = 6;
    }
          ...
          <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-100 rounded-xl">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold">
                  {duration === '1 day trip' ? '8-10 hours' : '2 days'}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-semibold text-green-800">
                  {optimizedRoute.length} {duration === '1 day trip' ? '/ 3 max' : duration === '2 days 1 night' ? '/ 6 max' : 'places'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
            <div className="flex items-center justify-between">
              ...
              {(duration === '1 day trip' || duration === '2 days 1 night') && (
                <button
